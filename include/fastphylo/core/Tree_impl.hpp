...
TREE_TEMPLATE void TREE::drawSubtree(std::ostream &os, const TREENODE *n, std::string &prefix) const
{
    if (n == root)
    {
        if (root == nullptr)
...
TREE_TEMPLATE void TREE::drawSubtreeIDs(std::ostream &os, const TREENODE *n, std::string &prefix) const
{
    if (n == root)
    {
        if (root == NULL)
...
TREE_TEMPLATE bool TREE::isBinary() const
{
...
TREE_TEMPLATE void TREE::moveNode(TREENODE *node, TREENODE *newparent)
{
    if (node->isRoot())
    {
...
TREE_TEMPLATE void TREE::joinTreeAtNode(TREENODE *n, TREE &t)
{
...
TREE_TEMPLATE void TREE::joinTreeAtNodes(TREENODE *n, TREENODE *node_other_tree)
{
...
TREE_TEMPLATE TREENODE *TREE::insertNodeOnPathToParent(TREENODE *n, Data newparentdata)
{
...
TREE_TEMPLATE void TREE::splittTree(TREENODE *new_tree_root, TREE &new_tree)
{
...
TREE_TEMPLATE TREENODE *TREE::detachFromParentAndAddAsSiblings(TREENODE *a, TREENODE *b, Data newparentdata)
{
...
TREE_TEMPLATE void TREENODE::detachFromParent()
{
...
TREE_TEMPLATE void TREE::removeAndDelete(TREENODE *n)
{
...
TREE_TEMPLATE void TREE::reRootAt(TREENODE *n)
{
    if (n->ownertree != this)
    {
...
TREE_TEMPLATE void TREENODE::setAsRoot()
{
    if (isRoot())
        return;
...
TREE_TEMPLATE bool TREE::reRootAtHighDegreeNode()
{
...
TREE_TEMPLATE TREENODE *TREE::shortcutNode(TREENODE *n)
{
    if (n->isLeaf())
    {
        TREENODE *p = n->parent;
...
TREE_TEMPLATE void TREE::collapse(TREENODE *n)
{
...
TREE_TEMPLATE void TREE::collapseChildren(TREENODE *n)
{
    NodeVector vec;
...
TREE_TEMPLATE void TREE::makeCanonical(const std::vector<TREENODE *> &leafs)
{
...
TREE_TEMPLATE int TREENODE::getNumChildren() const
{
...
//-------------------
TREE_TEMPLATE size_t TREENODE::getDegree() const
{
    size_t degree = 0;
    if (parent != nullptr)
        degree++;
...
TREE_TEMPLATE TREENODE *TREENODE::addChild(Data d)
{
...
//------------------------------------
TREE_TEMPLATE TREENODE *TREENODE::getRightMostSibling()
{
...
TREE_TEMPLATE const TREENODE *TREENODE::getRightMostSibling() const
{
...
//------------------------------------
TREE_TEMPLATE const TREENODE *TREENODE::getLeftMostSibling() const
{
...
TREE_TEMPLATE TREENODE *TREENODE::getLeftMostSibling()
{
...
TREE_TEMPLATE const TREENODE *TREENODE::getLeftMostChild() const
{
...
TREE_TEMPLATE TREENODE *TREENODE::getLeftMostChild()
{
...
//-------------------------------------------
TREE_TEMPLATE const TREENODE *TREENODE::getRightSiblingOfAncestor() const
{
...
TREE_TEMPLATE TREENODE *TREENODE::getRightSiblingOfAncestor()
{
...
TREE_TEMPLATE const TREENODE *TREENODE::getRightMostDescendantLeaf() const
{
...
TREE_TEMPLATE TREENODE *TREENODE::getRightMostDescendantLeaf()
{
...
//----------------------------------------
TREE_TEMPLATE const TREENODE *TREENODE::getLeftMostDescendantLeaf() const
{
...
TREE_TEMPLATE TREENODE *TREENODE::getLeftMostDescendantLeaf()
{
...
//
TREE_TEMPLATE void TREE::addNodesInPrefixOrder(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addNodesInPrefixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addNodesInPostfixOrder(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addNodesInPostfixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n)
{
    if (n == NULL)
        return;
...
TREE_TEMPLATE void TREE::addNodesInPrefixOrderLeftRight(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == NULL)
        return;
...
TREE_TEMPLATE void TREE::addNodesInInfixOrder(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addNodesInInfixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n)
{
    if (n == NULL)
        return;
...
TREE_TEMPLATE void TREE::addLeafs(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addLeafs(std::vector<const TREENODE *> &nodes, const TREENODE *n)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addInternalNodes(std::vector<TREENODE *> &nodes, TREENODE *n)
{
    if (n == NULL)
        return;
...
TREE_TEMPLATE void TREE::addNodesWithDegree(std::vector<TREENODE *> &nodes, TREENODE *n, size_t degree)
{
    if (n == nullptr)
        return;
...
TREE_TEMPLATE void TREE::addNodesOnPath(std::vector<TREENODE *> &nodes, TREENODE *n1, TREENODE *n2)
{
...
TREE_TEMPLATE void TREE::addNodesOnPathExceptLCA(std::vector<TREENODE *> &nodes, TREENODE *n1, TREENODE *n2)
{
...
TREE_TEMPLATE void TREE::addNodesInIdOrder(std::vector<const TREENODE *> &nodes) const
{
