...
class Tree : public Object
{
  public:
    ...
    void drawTreeIDs(std::ostream &os) const
    {
        std::string prefix;
        this->drawSubtreeIDs(os, root, prefix);
    }
    void drawSubtreeIDs(std::ostream &os, const TREENODE *node, std::string &prefix) const;

    void drawTree(std::ostream &os) const
    {
        this->drawSubtree(os, root);
    }
    ...
    {
        std::string prefix;
        this->drawSubtree(os, node, prefix);
    };
    ...
    void addNodesInPrefixOrder(std::vector<TREENODE *> &nodes)
    {
        addNodesInPrefixOrder(nodes, root);
    }
    static void addNodesInPrefixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n);
    void addNodesInPrefixOrder(std::vector<const TREENODE *> &nodes) const
    {
        addNodesInPrefixOrder(nodes, root);
    }
    ...
    void addNodesInPrefixOrderLeftRight(std::vector<TREENODE *> &nodes)
    {
        addNodesInPrefixOrderLeftRight(nodes, root);
    }

    // POSTFIX ORDER
    static void addNodesInPostfixOrder(std::vector<TREENODE *> &nodes, TREENODE *n);
    void addNodesInPostfixOrder(std::vector<TREENODE *> &nodes)
    {
        addNodesInPostfixOrder(nodes, root);
    }
    static void addNodesInPostfixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n);
    void addNodesInPostfixOrder(std::vector<const TREENODE *> &nodes) const
    {
        addNodesInPostfixOrder(nodes, root);
    }
    ...
    void addNodesInInfixOrder(std::vector<TREENODE *> &nodes)
    {
        addNodesInInfixOrder(nodes, root);
    }
    static void addNodesInInfixOrder(std::vector<const TREENODE *> &nodes, const TREENODE *n);
    void addNodesInInfixOrder(std::vector<const TREENODE *> &nodes) const
    {
        addNodesInInfixOrder(nodes, root);
    }
    ...
    void addLeafs(std::vector<TREENODE *> &nodes)
    {
        addLeafs(nodes, root);
    };
    static void addLeafs(std::vector<const TREENODE *> &nodes, const TREENODE *n);
    void addLeafs(std::vector<const TREENODE *> &nodes) const
    {
        addLeafs(nodes, root);
    };
    ...
    void addInternalNodes(std::vector<TREENODE *> &nodes)
    {
        addInternalNodes(nodes, root);
    };
    ...
    void addNodesWithDegree(std::vector<TREENODE *> &nodes, size_t degree)
    {
        addNodesWithDegree(nodes, root, degree);
    };
...
class TreeNode : public Object
{
  public:
    ...
    {
        return (!isRoot() && parent->rightMostChild == this);
    }
    bool isDescendantOf(TREENODE *n)
    {
        if (getParent() == NULL)
            ...
            return getParent()->isDescendantOf(n);
    }
    ...
    const TREENODE *getRightMostChild() const
    {
