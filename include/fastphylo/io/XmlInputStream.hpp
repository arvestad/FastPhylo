...
class XmlSequenceReader
{
  ...
  private:
    ...
    std::optional<bool> handleSeqNode(int depth, xmlReaderTypes type, const xmlChar *name, std::vector<Sequence> &seqs,
                                      Extrainfos &extrainfos, int &numSequences);
    std::optional<bool> handleExtrainfoNode(int depth, xmlReaderTypes type, const xmlChar *name,
    ...
    std::optional<bool> handleRunNode(int depth, xmlReaderTypes type, const xmlChar *name, std::string &runId,
                                      Extrainfos &extrainfos);
};
