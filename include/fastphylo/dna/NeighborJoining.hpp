    ...
    Data defaultNodeData)
{
    ...
    while (numNodes > 3)
    {
        ...
        TreeNode_type *newparent = dm.getIdentifier(mini)->getTree()->detachFromParentAndAddAsSiblings(
            dm.getIdentifier(mini), dm.getIdentifier(minj), defaultNodeData);
...
template <class TreeNode_type, class Data>
void computeBioNJTree(DistanceMatrix<TreeNode_type *, double, Data_init<TreeNode_type *>, Data_printOn<TreeNode_type *>,
                                     Data_init<double>, Data_printOn<double>> &dm,
                      Data defaultNodeData)
{
    ...
    while (numNodes > 3)
    {
        ...
        { // skip last row
            ...
            V.setDistance(i, mini,
                          lambda * V.getDistance(i, mini) + (1 - lambda) * V.getDistance(i, minj) -
                              lambda * (1 - lambda) * V_a2b);
...
template <class TreeNode_type, class Data>
void computeFNJTree(DistanceMatrix<TreeNode_type *, double, Data_init<TreeNode_type *>, Data_printOn<TreeNode_type *>,
                                   Data_init<double>, Data_printOn<double>> &dm,
                    Data defaultNodeData)
{
    ...
    while (numNodes > 3)
    {
        ...
        if (minj != numNodes - 1)
        {
            ...
            { // minj needs to be swapped to the last row
