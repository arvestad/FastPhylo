...
#include <simde/x86/sse2.h>
    ...
    static __inline b128 set_first_int_b128(int i0)
    {
        return _mm_cvtsi32_si128(i0);
    }

    static __inline b128 set_zero_b128()
    {
        return _mm_setzero_si128();
    }

    // sets all bytes to be b.
    static __inline b128 set_all_bytes(char b)
    {
        return _mm_set1_epi8(b);
    }
    // sets all shorts to be b
    static __inline b128 set_all_shorts(short b)
    {
        return _mm_set1_epi16(b);
    }
    // sets all ints to be b
    static __inline b128 set_all_ints(int b)
    {
...
#define set_immediate_int16_b128(__A, __B, __IMM) _mm_insert_epi16(__A, __B, __IMM)
    ...
    //--------------------------
    // ADDITION
    static __inline b128 add_b128(b128 a, b128 b)
    {
        return _mm_add_epi32(a, b);
    }
    // SUBTRACTION
    static __inline b128 sub_b128(b128 a, b128 b)
    {
        return _mm_sub_epi32(a, b);
    }

    // BITWISE XOR returns a ^ b
    static __inline b128 xor_b128(b128 a, b128 b)
    {
        return _mm_xor_si128(a, b);
    }
    // BITWISE OR returns a | b
    static __inline b128 or_b128(b128 a, b128 b)
    {
        return _mm_or_si128(a, b);
    }
    // BITWISE AND returns a & b
    static __inline b128 and_b128(b128 a, b128 b)
    {
        return _mm_and_si128(a, b);
    }
    // BITWISE AND NOT returns (~a) & b
    static __inline b128 andnot_b128(b128 a, b128 b)
    {
        return _mm_andnot_si128(a, b);
    }
    // BITWISE NEGATE returns (~a)
    static __inline b128 negate_b128(b128 a)
    {
    ...
    //             ,1) returns 1
    static __inline b128 shift_each32_bits_right_b128(b128 a, b128 b)
    {
    ...
    //             ,1) returns 4
    static __inline b128 shift_each32_bits_left_b128(b128 a, b128 b)
    {
    ...
    static __inline b128 get_from_mem_b128(const b128 *ptr, int pos)
    {
        return _mm_load_si128(ptr + pos);
    }
    static __inline b128 get_b128(const b128 *ptr)
    {
        return _mm_load_si128(ptr);
    }

    static __inline void set_b128(b128 *ptr, b128 val)
    {
        _mm_store_si128(ptr, val);
    }

    static __inline void set_b128_NOCACHEPOLLUTE(b128 *ptr, b128 val)
    {
    ...
    //
    // dst <- dst OR src
    static __inline void mem_or_b128(b128 *dst, const b128 *src, const int num_b128s)
    {
    ...
    static __inline void mem_and_b128(b128 *dst, const b128 *src, const int num_b128s)
    {
        b128 t1, t2;
        // walk through four 128s in each row
        const b128 *src_end = src + (num_b128s - 3);
    ...
    static __inline void mem_xor_b128(b128 *dst, const b128 *src, const int num_b128s)
    {
        b128 t1, t2;
        // walk through four 128s in each row
        const b128 *src_end = src + (num_b128s - 3);
    ...
    // dst <- (~dst) & src
    static __inline void mem_andnot_b128(b128 *dst, const b128 *src, const int num_b128s)
    {
        b128 t1, t2;
        // walk through four 128s in each row
        const b128 *src_end = src + (num_b128s - 3);
    ...
    // dst <- dst & (~src)
    static __inline void mem_reversed_andnot_b128(b128 *dst, const b128 *src, const int num_b128s)
    {
...
#ifdef __cplusplus
template <int ImmBytes> static inline b128 shift_bytes_left_b128(b128 a)
{
    return _mm_slli_si128(a, ImmBytes);
}

template <int ImmBytes> static inline b128 shift_bytes_right_b128(b128 a)
{
