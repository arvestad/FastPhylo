...
void fillMatrix_Hamming(StrDblMatrix &dm, std::vector<DNA_b128_String> &seqs, sequence_translation_model trans_model);
...
// of b128_strings[i].
void DNA_b128_StringsFromPHYLIP(std::istream &fin, std::vector<std::string> &names,
