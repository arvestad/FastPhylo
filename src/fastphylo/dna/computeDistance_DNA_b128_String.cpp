...
static void sumRemainderBlocks(int rest_num_b128s, b128 &total_sum_ts, b128 &total_sum_tv, b128 &total_sum_del)
{
    b128 diff;
    b128 del;
    b128 tmp_tv;
...
simple_string_distance DNA_b128_String::computeDistance(const DNA_b128_String &s1, const DNA_b128_String &s2)
{
    ...
    simple_string_distance d = {get_int_0_b128(total_sum_del), static_cast<float>(get_int_0_b128(total_sum_ts)),
...
static __inline void dist_level_1(b128 &sum_ts_l1, b128 &sum_tv_l1, b128 &sum_del_l1)
{
    b128 diff1;
    b128 diff2;
    b128 diff3;
...
//
void dist_level_2(b128 &sum_ts_l2, b128 &sum_tv_l2, b128 &sum_del_l2)
{
    b128 sum_ts_l1;
    b128 sum_tv_l1;
    b128 sum_del_l1;
...
// level 3.
void dist_level_3(b128 &sum_ts_l3, b128 &sum_tv_l3, b128 &sum_del_l3)
{
    b128 sum_ts_l2;
    b128 sum_tv_l2;
    b128 sum_del_l2;
...
//
//
void dist_level_4(b128 &sum_ts_l4, b128 &sum_tv_l4, b128 &sum_del_l4)
{
    b128 sum_ts_l3;
    b128 sum_tv_l3;
    b128 sum_del_l3;
