...
FastaInputStream::FastaInputStream(char *filename) : reader(filename, "acgtumrwsykvhdbnxACGTUMRWSYKVHDBNX -.?")
{
}

bool FastaInputStream::read(vector<DNA_b128_String> &b128seqs, string &runId, vector<string> &names,
