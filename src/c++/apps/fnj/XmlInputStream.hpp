...
class XmlInputStream : public DataInputStream
{
  ...
  private:
    ...
    std::optional<readstatus> handleDmNode(int depth, xmlReaderTypes type, const xmlChar *name,
                                           std::vector<std::string> &names, StrDblMatrix &dm);
    std::optional<readstatus> handleIdentityNode(int depth, xmlReaderTypes type, const xmlChar *name,
                                                 std::vector<std::string> &names, Extrainfos &extrainfos,
                                                 int &nr_of_ids);
    std::optional<readstatus> handleExtrainfoNode(int depth, xmlReaderTypes type, const xmlChar *name,
    ...
    std::optional<readstatus> handleIdentitiesNode(int depth, xmlReaderTypes type, const xmlChar *name,
                                                   std::vector<std::string> &names, Extrainfos &extrainfos);
